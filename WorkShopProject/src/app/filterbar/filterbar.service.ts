...
export class FilterbarService {
    ...
    getCities() {
        return [
            new City(1, 17, 2, 'Pune'),
            new City(2, 17, 2, 'Mumbai'),
            new City(3, 27, 3, 'SSS'),
            new City(4, 27, 3, 'AAA'),
            new City(5, 25, 2, 'Bhopal'),
            new City(6, 21, 2, 'Lucknow'),
            new City(7, 21, 2, 'Barielly'),
            new City(8, 21, 2, 'Amethi'),
            new City(9, 24, 2, 'Ahmedabad'),
            new City(10, 24, 2, 'Gandhinagar'),
            new City(11, 24, 2, 'Rajkot'),
        ];
    }
